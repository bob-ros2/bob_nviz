...
![Build Status](https://github.com/bob-ros2/bob_nviz/actions/workflows/ros2_ci.yaml/badge.svg)
...
```bash
ros2 topic pub --once /events std_msgs/msg/String "{data: '[{\"action\":\"add\", \"type\":\"String\", \"id\":\"main\", \"title\":\"Bob-nviz\", \"topic\":\"/eva/llm\", \"area\":[50, 50, 400, 300], \"font_size\": 16}]'}"
```
...
ros2 topic pub --once /events std_msgs/msg/String "{data: '[{\"action\":\"add\", \"type\":\"Bitmap\", \"id\":\"ico\", \"area\":[20, 20, 16, 16], \"topic\":\"/eva/heart\", \"depth\": 1, \"color\":[255, 0, 0, 255]}]'}"
...
---
Built by Eva & Antigravity for the **bob-ros2** ecosystem.
